...
> 
> ⏳ **Nelle prossime versioni**, introdurremo ufficialmente il supporto e l'installer `.exe` per i sistemi operativi **Windows**. Supporto multipiattaforma in arrivo!

Per installare su macOS:
1. Scarica il file `TrueHash Forensics.dmg` allegato in fondo a questa pagina, nella sezione Assets.
2. Apri il file `.dmg`.
...
>
> ⏳ **In future versions**, we will officially introduce support and an `.exe` installer for **Windows** operating systems. Cross-platform support is coming!

To install on macOS:
1. Download the `TrueHash Forensics.dmg` file attached to this release (in the Assets section).
2. Open the `.dmg` file.
